 ...
 * @since 2021-03-10
 */
@Import(HelloworldScheduleTests.HelloworldSchedule.class)
public class HelloworldScheduleTests extends AbstractLtsClientApplication {
	...
	@LTS
	@Slf4j
	public static class HelloworldSchedule implements InitializingBean{
		@Autowired
